 ...
 * 가격은 본문 가격 블록이 「지금 등록하면 0원 · 이후 월 4,900원」으로 말한다.
      ...
      <main className="mx-auto flex max-w-xl flex-col gap-8 px-5 pb-16 pt-4">
        ...
        {/* ─────────────────────────────────────────────────────────────
            ...
            2줄 구조이고 순서·문구가 고정이다:
              ...
              2행  지금 등록하면 0원 · 이후 월 4,900원  ← 🔴 절대 움직이지 않는다

            🔴 2행에서 「이후 월 4,900원」을 지우지 말 것. 「0원」과 겹쳐 보여 중복처럼
               읽히지만 반복이 아니라 조건부 재진술이고, 지우면 6개월 뒤 얼마인지가
               화면에서 사라져 **청구서가 첫 대면이 된다.** 이 이유는 문구가 바뀌어도
               유효하다.
            🔴 2행의 「0원」도 지우지 말 것. 지우면 "지금 등록하면 · 이후 월 4,900원"이
               되어 지금 등록하면 무엇인지가 사라진다.

            ⚠️ 문구 이력: 처음엔 「6개월간 0원 · 이후 월 4,900원」이었다.
               오너 확정(2026-08-11)으로 「6개월」을 빼고 「지금 등록하면」으로 바꿨다.
