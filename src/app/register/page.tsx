    ...
    <div className="min-h-screen bg-surface">
      ...
      <main className="mx-auto flex max-w-xl flex-col gap-8 px-5 pb-16 pt-4">
        ...
        {/* ─────────────────────────────────────────────────────────────
            ...
            🔴 「선착순 100개」이고 「지점」은 뺐다 - 폭 제약이다(디자인 실측).
                 「…선착순 100개 지점」  331.4px · 여유 3.6px  → nowrap이라 폰트 폴백
                                                                 한 번이면 경고 없이 잘린다
                 「…선착순 100개」       288.8px · 여유 46.2px ✅
               홈 팝업·지도 카드는 「선착순 100개 지점」이라 표기가 다르지만 같은 사실이고
               생략만 다르다. metadata title도 「선착순 100개」라 이쪽과 일치한다.
               🔴 「지점」을 되살리려면 폭을 먼저 재라.
               ⚠️ 폰트를 줄여(20→19px) 문구를 욱여넣는 안은 채택하지 않았다(CTO) -
               순서가 반대다. 기간 줄은 20px 그대로다.
