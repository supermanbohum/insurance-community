    ...
    >
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-surface-sunken">
        ...
        {rank !== undefined && rank <= 3 && (
          <span className="absolute right-2 top-2 flex items-center gap-0.5 rounded-full bg-white/95 px-2 py-0.5 text-[10px] font-bold text-rose-500 shadow-sm backdrop-blur">
            🔥 HOT
          </span>
        )}
      </div>
