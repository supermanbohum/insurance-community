...
export function HeroSearch() {
  return (
    <div className="relative flex w-full flex-col gap-4 overflow-hidden rounded-2xl bg-gradient-to-br from-brand-600 via-brand-600 to-brand-800 px-5 py-7 shadow-pop sm:px-7 sm:py-9">
      <div
      ...
      <div className="relative z-10 flex flex-col gap-3">
        ...
        <form action="/search" className="relative w-full">
          ...
          <input
            ...
            className="w-full rounded-full border-0 bg-white py-3 pl-10 pr-4 text-sm text-ink shadow-card outline-none ring-0 transition-shadow placeholder:text-ink-faint focus:shadow-card-hover"
          />
        </form>
      </div>
    </div>
