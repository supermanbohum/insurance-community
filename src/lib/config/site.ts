...
export const COMPANY_INFO = {
  ...
  // 정식 카카오톡 채널(보험맵, 2026-08-10 사업자 인증 완료본으로 교체) - 오픈채팅방
  // (open.kakao.com)이 아니다. /delete-account가 이 값을 개인정보 삭제 요청 창구로
  // 안내하므로(제7조), 익명 참여가 가능하고 언제든 사라질 수 있는 오픈채팅방을 여기
  // 다시 쓰지 않는다. /chat까지 붙여 "채널 구경"이 아니라 바로 대화가 시작되게 한다.
  // 구 채널(_aNxoBX, 2026-08-09 개설, 사업자 미인증이라 채팅 화면에 주의 표시가 떴다)은
  // 이 배포 확인 전까지만 살려두고 CTO가 별도로 정리한다.
  kakaoChannelUrl: 'https://pf.kakao.com/_PFIiX/chat',
